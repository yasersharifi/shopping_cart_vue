            ...
            <v-col cols="3" v-for="(item, index) in products" :key="index">
                <v-card class="card-1 card-div">
                    <div class="like-icon-div">
                        <label for="card-1-like" class="like-icon-div-child">
                            ...
                            <v-icon
                                ...
                                @click="$emit('liked', index)">mdi-heart</v-icon>
                        </label>
                    </div>
                    ...
                    <v-card-text style="z-index: 1">
                        ...
                        <p class="date"> Departure date: {{ item.date }} </p>
                        <v-divider></v-divider>
                        <div class="pricing-and-cart my-0">
                            <div class="pricing">
                                <p class="previous-price">${{ item.previousPrice }}</p>
                                <p class="current-price orange--text">${{ item.currentPrice }}</p>
                            </div>
                            <v-icon @click="$emit('cart', item)" class="cursor-pointer" large color="teal darken-2"> mdi-cart </v-icon>
                        </div>
                    </v-card-text>
                </v-card>
            </v-col>
